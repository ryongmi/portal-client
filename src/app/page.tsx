            ...
            <div className="flex items-center space-x-3">
              {!isAuthenticated ? (
                ...
                <>
                  <Link
                    href="/admin"
                    className="inline-flex items-center px-3 py-2 text-gray-500 hover:text-blue-700 text-sm font-medium rounded-lg hover:bg-blue-50 transition-all duration-200"
                  >
                    <svg
